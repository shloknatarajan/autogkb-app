    ...
    <div>
      ...
      <div className="space-y-3">
        ...
        {studyParameters.study_type && (
          <div className="mb-4">
            <h4 className="font-medium text-sm text-foreground mb-1">Study Type</h4>
        ...
        {studyParameters.participant_info && (
          <div className="mb-4">
            <h4 className="font-medium text-sm text-foreground mb-1">Participant Information</h4>
        ...
        {studyParameters.study_design && (
          <div className="mb-4">
            <h4 className="font-medium text-sm text-foreground mb-1">Study Design</h4>
        ...
        {studyParameters.study_results && (
          <div className="mb-4">
            <h4 className="font-medium text-sm text-foreground mb-1">Study Results</h4>
